...
#[test]
fn q29_coexisting_facets_retain_evidence_without_selecting_a_type() {
    ...
    assert!(wire.get("facets").is_none());
    assert!(wire.get("document_consistency").is_none());
}

#[test]
fn q30_partial_filesystem_coverage_keeps_unsatisfied_obligations_unknown() {
...
#[test]
fn q30_conflict_pair_limit_is_visible_as_partial_coverage() {
