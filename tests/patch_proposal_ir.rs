...
#[test]
fn planner_binds_safe_edit_to_scanner_base_and_applies_only_in_memory() {
...
#[test]
fn stale_base_is_rejected_before_application() {
    let source = b"# Demo\n";
...
#[test]
fn overlap_and_coincident_insertions_are_rejected() {
    let source = b"abcdef\n";
...
#[test]
fn unknown_encoding_and_utf8_split_spans_are_rejected() {
...
#[test]
fn unresolved_policy_content_is_held() {
...
#[test]
fn replacement_eol_and_current_eol_mismatches_are_rejected() {
    let source = b"# Demo\r\n";
...
#[test]
fn wire_rejects_inverted_spans_and_malformed_digests() {
    let source = b"# Demo\n";
    let proposal = literal_proposal(
        source,
        vec![PatchTextEdit::literal(
