...
#[test]
fn q28_parses_supported_local_github_documents_without_execution() {
    ...
    assert!(wire.get("github_local_documents").is_none());
}

#[test]
fn q28_budgets_and_malformed_documents_remain_typed_and_span_aware() {
...
#[test]
fn q28_unsupported_yaml_is_local_unknown_with_a_precise_span() {
...
fn document_ir(snapshot: &seiri_core::RepoSnapshot, kind: GithubDocumentKind) -> &GithubDocumentIr {
    snapshot
        .github_local_documents
        .documents()
        .iter()
