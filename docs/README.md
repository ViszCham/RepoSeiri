...
| 3 | [Design Documentation](design/README.md) | Repository Trust Graph、baseline、repair、roadmap の入口です。 |
| 4 | [Release Process](release.md) | release 判断、pre-release check、互換性境界の入口です。 |
| 5 | [Changelog](../CHANGELOG.md) | 利用者向け変更履歴の正です。 |
| 6 | [Repository Hygiene](hygiene.md) | `.gitignore`、`.gitattributes`、generated output 境界の入口です。 |
| 7 | [Self-Audit Loop](self-audit.md) | RepoSeiri が RepoSeiri 自身を確認する loop の入口です。 |
...
| 3 | [Design Documentation](design/README.md) | Entry for Repository Trust Graph, baseline, repair, and roadmap material. |
| 4 | [Release Process](release.md) | Entry for release decisions, pre-release checks, and compatibility boundaries. |
| 5 | [Changelog](../CHANGELOG.md) | Canonical user-facing change history. |
| 6 | [Repository Hygiene](hygiene.md) | Entry for `.gitignore`, `.gitattributes`, and generated-output boundaries. |
| 7 | [Self-Audit Loop](self-audit.md) | Entry for the loop where RepoSeiri checks RepoSeiri itself. |
