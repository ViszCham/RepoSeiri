...
| Q20-Q34後のBlock X-AD、低レイヤRust contract、private calibration、Git/scope、delta/planner | [Roadmap v4: Low-level Semantic Closure And Expansion](design/roadmap-v4-low-level-expansion.md) |
...
| Blocks X-AD after Q20-Q34, low-level Rust contracts, private calibration, Git/scope, and delta/planner | [Roadmap v4: Low-level Semantic Closure And Expansion](design/roadmap-v4-low-level-expansion.md) |
