...
| 3 | [Publication Readiness](publication-readiness.md) | private のまま公開直前まで整理するための checklist です。 |
| 4 | [Design Documentation](design/README.md) | Repository Trust Graph、baseline、repair、roadmap の入口です。 |
| 5 | [Release Process](release.md) | release 判断、pre-release check、互換性境界の入口です。 |
...
| Publication readiness | `docs/publication-readiness.md`, `.github/CODEOWNERS` | private のまま公開直前まで整える checklist、ownership 境界 | visibility 変更、法務判断、security outcome 保証 |
| Governance | `GOVERNANCE.md` | 個人使用リポとしての意思決定境界、外部 contribution 境界 | 実装設計、support SLA、security outcome 保証 |
...
| 公開直前の確認 | [Publication Readiness](publication-readiness.md) |
...
| 3 | [Publication Readiness](publication-readiness.md) | Checklist for organizing the private repository up to the point just before publication. |
| 4 | [Design Documentation](design/README.md) | Entry for Repository Trust Graph, baseline, repair, and roadmap material. |
| 5 | [Release Process](release.md) | Entry for release decisions, pre-release checks, and compatibility boundaries. |
...
| Publication readiness | `docs/publication-readiness.md`, `.github/CODEOWNERS` | Checklist for pre-publication organization while private, and ownership boundary | Visibility changes, legal judgment, security outcome guarantees |
| Governance | `GOVERNANCE.md` | Decision boundary and external contribution boundary for a personal-use repository | Implementation design, support SLA, security outcome guarantees |
...
| Pre-publication checks | [Publication Readiness](publication-readiness.md) |
