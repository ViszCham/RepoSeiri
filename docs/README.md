...
| Q12-Q19 evidence kernel、route assessment、scanner、patch proposal、Codex view | [Low-level Claim Boundary Roadmap](design/low-level-claim-boundary-roadmap.md) |
...
| Q12-Q19 evidence kernel, route assessment, scanner, patch proposal, and Codex views | [Low-level Claim Boundary Roadmap](design/low-level-claim-boundary-roadmap.md) |
