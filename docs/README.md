...
| 3 | [Design Documentation](design/README.md) | trust graph、baseline/profile、Roadmap v5/v6実装記録、RCBP-v1 |
...
| 1.0.0実装と完成条件 | [Roadmap v6](design/roadmap-v6-completion.md) |
...
| 3 | [Design Documentation](design/README.md) | Trust graph, baseline/profile model, Roadmap v5/v6 records, and RCBP-v1 |
...
| Canonical 0.2.0 Rust architecture | [Roadmap v5](design/roadmap-v5-legacy-removal.md) |
| 1.0.0 implementation and completion conditions | [Roadmap v6](design/roadmap-v6-completion.md) |
