...
| Publication readiness | `docs/publication-readiness.md`, `.github/CODEOWNERS` | 公開リポジトリとして扱うための checklist、ownership 境界 | visibility 変更の自動化、法務判断、security outcome 保証 |
...
| Publication readiness | `docs/publication-readiness.md`, `.github/CODEOWNERS` | Checklist for treating the repository as public, and ownership boundary | Automating visibility changes, legal judgment, security outcome guarantees |
