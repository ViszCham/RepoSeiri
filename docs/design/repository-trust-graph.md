...
| `roadmap-v5-legacy-removal.md` | Canonical Core IR、Rust module 境界、実装 block、strict wire、verification。 |
...
2. [Roadmap v5: Legacy Removal](roadmap-v5-legacy-removal.md)
...
| `roadmap-v5-legacy-removal.md` | Canonical Core IR, Rust module boundaries, implementation blocks, strict wire contracts, and verification. |
