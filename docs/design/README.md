...
| 5 | [RCBP-v1](completion-batch-protocol.md) | 一括指示を内部sliceへ分解するCodex実行契約 |
| 6 | [RCBP-v1 Template](rcbp-v1-template.json) | block依存、authority既定値、stateの機械可読正本 |
...
| 5 | [RCBP-v1](completion-batch-protocol.md) | Codex execution contract that decomposes one batch instruction into internal slices |
| 6 | [RCBP-v1 Template](rcbp-v1-template.json) | Machine-readable authority for block dependencies, authority defaults, and states |
