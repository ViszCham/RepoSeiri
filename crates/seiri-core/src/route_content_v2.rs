...
pub struct ContentSlotSpec {
    ...
    #[serde(skip)]
    pub legacy_important_files: &'static [ImportantFileKind],
    pub indicates: &'static [MeaningAtom],
    pub does_not_indicate: &'static [ClaimBoundaryKind],
    #[serde(skip)]
    pub legacy_atom: Option<RouteContentAtom>,
}
...
pub static ROUTE_CONTENT_CONTRACT_V2: &[ContentSlotSpec] = &[
    slot!(
        1,
        "identity.purpose",
        Identity,
    ...
    ContentSlotSpec {
        ...
        legacy_atom: Some(RouteContentAtom::AutomationStatusSignal),
    },
    slot!(
        55,
    ...
    ContentSlotSpec {
        ...
        markers: &["artifact storage", "cache", "retention"],
        important_files: &[],
        legacy_markers: &["format", "formatting", "style", "editorconfig"],
        legacy_important_files: &[ImportantFileKind::EditorConfig],
        indicates: OBSERVED,
        does_not_indicate: NONE,
        legacy_atom: Some(RouteContentAtom::HygieneFormattingPolicy),
    },
];

#[must_use]
pub fn route_content_contract_v2() -> &'static [ContentSlotSpec] {
    ROUTE_CONTENT_CONTRACT_V2
}
